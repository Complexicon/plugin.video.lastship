...
class source:
    ...
    def movie(self, imdb, title, localtitle, aliases, year):
        try:
            url = 'https://apis.justwatch.com/content/titles/de_DE/popular?body=%7B"languages":"de","content_types":["movie"],"providers":["nfx"],"monetization_types":["flatrate"],"page":1,"page_size":20,"query":"{}"%7D'.format(localtitle)
